      ...
      <Grid container spacing={2} sx={{ marginBottom: "30px" }}>
        <Grid xs>
          <Card>
            ...
            <Typography level="h3">
              {!power ? (
                <Skeleton sx={{ marginBottom: "8px" }} variant="rounded" height={"30px"} width={"80px"} />
              ) : (
                <>
                  ...
                  <Grid container sx={{ marginBottom: "20px" }}>
                    <Grid xs>
                      <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                        {powerGroup.FuseTriggered === true ? (
                          <BsExclamationCircle size={"20px"} style={{ marginRight: "10px" }} />
                        ) : (
                          <></>
                        )}
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid xs>
                      <Card variant="outlined">
                        ...
                        <Typography level="body2">Current consumption</Typography>
                      </Card>
                    </Grid>
                    <Grid xs>
                      <Card variant="outlined">
                    ...
                    <Grid container spacing={2} sx={{ marginTop: "20px" }}>
                      <Grid xs>
                        <Card variant="outlined">
                          ...
                          <Typography>{powerGroup.BatteryCapacity} MW</Typography>
                          <Typography level="body2">Battery Capacity</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
                          {/* <CardHeader title={powerGroup.BatteryPercent+ " %"} subheader="Battery Filled Percent"></CardHeader> */}
                          <Typography>{powerGroup.BatteryPercent} %</Typography>
                          <Typography level="body2">Battery Filled Percent</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
                          {/* <CardHeader title={powerGroup.BatteryDifferential+ " MW"} subheader="Battery Differential"></CardHeader> */}
                          <Typography>{powerGroup.BatteryDifferential} MW</Typography>
                          <Typography level="body2">Battery Differential</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
                          {/* <CardHeader title={powerGroup.BatteryTimeFull} subheader="Battery Full At Time"></CardHeader> */}
                          <Typography>{powerGroup.BatteryTimeFull}</Typography>
                          <Typography level="body2">Battery Full At Time</Typography>
                        </Card>
                      </Grid>
                    </Grid>
                  )}
