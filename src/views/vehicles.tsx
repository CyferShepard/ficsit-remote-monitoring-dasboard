                        ...
                        <Grid container spacing={2} sx={{ paddingX: 0 }}>
                          <Grid xs>
                            <Grid container>
                              ...
                              <Grid>
                                <Typography sx={{ color: "rgba(255,255,255,0.9)" }}>
                                  {parseInt(vehicle.ForwardSpeed)} km/h
                                </Typography>
                              </Grid>
                            </Grid>
                            <Grid container>
                            ...
                            <Grid container>
                              ...
                              <Grid>
                                <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center" }}>
                                  ...
                                  {vehicle.ForwardSpeed === 0 && parseInt(vehicle.EngineRPM) > 0 && (
                                    <Tooltip title="If the vehicle is too far away from player the speed cannot be read.">
                                      <IconButton sx={{ marginLeft: "10px" }} size="sm" color="neutral" variant="plain">
                                        <BsQuestionCircle />
                                      </IconButton>
                                    </Tooltip>
                                  )}
