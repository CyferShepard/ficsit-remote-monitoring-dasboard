              ...
              <Card sx={{ marginBottom: "20px" }} variant="outlined">
                <CardContent>
                  <Grid container padding={0}>
                    <Grid xs>
                      <Typography level="h5">{itemSelection.length} Favorite Items</Typography>
                      <Typography my={"5px"} startDecorator={<BsExclamationCircle />} level="body2">
                        Only shows stored and available items.
                      </Typography>
                      <Typography startDecorator={<BsExclamationTriangleFill />} level="body2">
                          ...
                          return (
                            <Grid xs={4}>
                              <Card variant="outlined" sx={{ height: "100%", padding: 0 }}>
                                <CardContent
                                  sx={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "16px" }}
                                >
                                  <img
                                    src={"./assets/" + itemRefs[item.Name]?.image ?? null}
                                    alt="image"
