                  ...
                  <Card variant={"outlined"}>
                    <CardContent>
                        ...
                        <Grid xs>
                          {_factory.IsProducing === true ? (
                            ...
                            <Chip
                              ...
                              color="danger"
                              variant="soft"
                              startDecorator={<BsExclamationTriangleFill style={{ marginRight: "5px" }} />}
                            >
                              Problems detected
                            </Chip>
                          )}
                      ...
                      <Stack alignItems={"center"}>
                        <img
                          src={"/assets/" + factoryRefs[factory as string]?.image ?? null}
                          alt="image"
                        ...
                        {_factory.IsConfigured === true && (
                          <Box>
                            <Grid spacing={0} container sx={{ marginTop: "10px" }}>
                              <Grid>
                                <img
                                  src={"/assets/" + itemRefs[_factory.ingredients[0].Name]?.image ?? null}
                                  alt="image"
                              ...
                              <Grid>
                                <img
                                  src={"/assets/" + itemRefs[_factory.production[0].Name]?.image ?? null}
                                  alt="image"
                                  style={{ height: "40px", width: "40px" }}
                                ></img>
                              </Grid>
