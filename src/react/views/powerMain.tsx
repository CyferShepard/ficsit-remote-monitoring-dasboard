import { Box, Card, CardContent, Chip, Container, Divider, Grid, IconButton, Skeleton, Typography } from "@mui/joy";
      ...
      <Grid container spacing={2} sx={{ marginBottom: "30px" }}>
        <Grid xs>
          <Card>
            <Typography level="h3">
              {!power ? (
                <Skeleton sx={{ marginBottom: "8px" }} variant="rectangular" height="30px" width="80px" />
              ) : (
                <>
        ...
        <Grid xs>
          {!power && (
            <Skeleton sx={{ marginBottom: "8px", width: "100%", borderRadius: "10px" }} variant="rectangular" height="93px" />
          )}
          {!!power && !fuseBroken && (
            <Card>
                ...
                <CardContent>
                  <Grid container sx={{ marginBottom: "20px" }}>
                    <Grid xs>
                      ...
                      >
                        {powerGroup.fuseTriggered && <BsExclamationCircle size="20px" style={{ marginRight: "10px" }} />}
                        <Typography level="h4">Power Circuit #{index + 1}</Typography>
                      </Box>
                    </Grid>
                    <Grid>
                      {powerGroup.fuseTriggered ? (
                        <Chip
                          variant="soft"
                          startDecorator={<BsExclamationTriangleFill size="17px" />}
                          sx={{ paddingLeft: "6px" }}
                          color="danger"
                        >
                          FUSE BROKEN
                        ...
                        <Chip variant="soft" startDecorator={<BsCheck size="22px" />} sx={{ paddingLeft: "6px" }} color="success">
                          Fuse: All Good
                        </Chip>
                      )}
                    </Grid>
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid xs>
                      ...
                      >
                        ...
                        <Typography level="body-md">Power Production</Typography>
                      </Card>
                    </Grid>
                    <Grid xs>
                      <Card variant="outlined">
                        ...
                        <Typography level="body-md">Current consumption</Typography>
                      </Card>
                    </Grid>
                    <Grid xs>
                      <Card variant="outlined">
                  ...
                  <Grid container sx={{ marginTop: "30px" }}>
                    ...
                    <Grid>
                      {powerGroup.batteryCapacity === 0 ? (
                        <Chip startDecorator={<BsCloudSlash size="20px" />} sx={{ paddingLeft: "6px" }} variant="soft">
                  ...
                  {powerGroup.batteryCapacity != 0 && (
                    <Grid container spacing={2} sx={{ marginTop: "20px" }}>
                      <Grid xs>
                        <Card variant="outlined">
                          <Typography level="h4">{powerGroup.batteryCapacity} MWh</Typography>
                          <Typography level="body-md">Battery Capacity</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
                          <Typography level="h4">{Math.round(powerGroup.batteryPercent * 100) / 100} %</Typography>
                          <Typography level="body-md">Battery Filled Percent</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
                          <Typography level="h4">{Math.round(powerGroup.batteryDifferential * 100) / 100} MW</Typography>
                          <Typography level="body-md">Battery Differential</Typography>
                        </Card>
                      </Grid>
                      <Grid xs>
                        <Card variant="outlined">
